...
const BehaviorTestEntries := [
	...
	{"id": "canvasResize", "path": "res://scripts/tests/CanvasResizeTest.gd"},
	...
	{"id": "simulationAsyncLoop", "path": "res://scripts/tests/SimulationAsyncLoopTest.gd"},
...
const CaptureTestEntries := [
	...
	{"id": "canvasResizeCapture", "path": "res://scripts/tests/CanvasResizeCaptureTest.gd", "legacyArgs": ["--captureCanvasResize"]},
