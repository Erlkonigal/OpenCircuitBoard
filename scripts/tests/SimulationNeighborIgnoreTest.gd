...
func run(context) -> void:
	...
	assert(not bool(board.call("getRuntimeTileState", readOutputCoordinates)))
	assert(not bool(board.call("getRuntimeTileState", writeTargetCoordinates)))
	assert(not bool(board.call("getRuntimeTileState", crossOutputCoordinates)))
	assert(not bool(board.call("getRuntimeTileState", meshOutputCoordinates)))
